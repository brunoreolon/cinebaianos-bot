ERROR_MESSAGES = {
    ...
    "user_already_exists_error": "Você já está registrado.",
    ...
    "invalid_vote_error": "⚠️ Voto inválido. Use um dos seguintes:\n`1 - DA HORA`\n`2 - LIXO`\n`3 - NÃO ASSISTI`",
    "spreadsheet_error": "TESTE",
    "column_not_found_error": "TESTE2",
}
